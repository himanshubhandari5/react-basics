...
class FormDemo extends Component<FormDemoProps, State> {
  bioRef: React.RefObject<HTMLTextAreaElement>;
  inputRef: React.RefObject<HTMLInputElement>;

  constructor(props: FormDemoProps) {
    super(props);
    this.state = {
      name: '',
      age: 0,
  ...
  render() {
    return (
      <>
        ...
        <ul>
          <li>
            In react forms, we have to bind event handler with bind(this), like
            this
          </li>
          <ul>
          ...
          <li>
            Other way is to use anonymous function while referencing it with the
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <p>
            By controlled inputs we mean, these are controlled by react State
          </p>
          <input
            type="text"
            autoFocus
          ...
          <input
            ...
            id="bike"
            name="bike"
            defaultChecked={this.state.bike}
            onChange={this.handleChange}
          />
          ...
          <p>
            These are uncontrolled Form Elements, meaning that these are handled
            by ref
          </p>
        ...
        <li>But I like: {this.state.VehicleILike}</li>
